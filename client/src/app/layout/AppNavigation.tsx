...
/**
 * The persistent left vertical navigation menu (app layer — design.md D1).
 * Renders the three destinations in a fixed order and lets `NavLink` drive
 * the active-state styling from the current location, rather than
 * duplicating location logic here.
 */
